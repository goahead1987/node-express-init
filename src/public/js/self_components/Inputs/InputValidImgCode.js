...
/**
 * <InputValidImgCode ref="name" input={this.disabledBtn} type="text" placeholder="帐号" />
 *
 * */

var InputCommon = require('./InputCommon');

var InputValidImgCode = React.createClass({
...
InputValidImgCode.getVal = function (obj) {
    return obj.refs.model.value;
};
InputValidImgCode.setVal = function (obj, value) {
    obj.refs.model.value = value;
};

module.exports = InputValidImgCode;